...
void encoder_print_during_drive(int throttle_cmd) {
  ...
  // Uses static rate-limit state and expects a single sequential caller
  // (currently main loop); concurrent/multi-path calls skew timing.
